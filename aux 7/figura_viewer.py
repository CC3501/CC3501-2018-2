...
-------------------------------------------------------------------------------
"""
from PyOpenGLtoolbox import *  # Se usará esta librería sólo para manejar la ventana de OpenGL
...
reshape_window(w=VENTANA_W, h=VENTANA_H, near=1, far=1000)
